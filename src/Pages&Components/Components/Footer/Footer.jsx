...
const Footer = () => {
    return (
        <div className="px-4 pt-16 bg-base-100 mx-auto w-full  md:px-24 lg:px-8 divide divide-gray-500">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    <span className="ml-2 text-2xl font-bold tracking-wide text-[#82CB15] uppercase">
                        Hospital
                    </span>
                </a>
                <div className="mt-6 lg:max-w-sm">
                    <p className="text-sm text-gray-900 font-semibold">
                    We made it easily to place an order when you are stuck in traffic
                    or on the way to pick up the kids.
                    </p>
                    <p className="mt-4 text-sm  font-semibold text-gray-900">
                    We provide the freedom to order from any place at any time without
                    pausing everything and making a call to the restaurant.
                    </p>
                </div>
                </div>
                <div className="space-y-2 text-sm">
                <p className="text-xl mb-6 font-bold tracking-wide text-gray-900">
                    Contacts
                </p>
